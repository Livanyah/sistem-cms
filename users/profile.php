...
<div class="col-sm-4">
<input type="text" name="ic" required="required" value="<?php echo htmlentities($row['ic']);?>" class="form-control">
</div>
</div>
...
<option value="<?php echo htmlentities($row['class']);?>"><?php echo htmlentities($st=$row['class']);?></option>
...
<label class="col-sm-2 col-sm-2 control-label">Sem </label>
<div class="col-sm-4">
<input type="text" name="sem" required="required" value="<?php echo htmlentities($row['sem']);?>" class="form-control">
</div>
</div>


<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">No.NDP</label>
<div class="col-sm-4">
<input type="text" name="ndp" maxlength="6" required="required" value="<?php echo htmlentities($row['ndp']);?>" class="form-control">
</div>
